@extends('admin.app', ['page' => __('Admin Profile'), 'pageSlug' => 'profile'])
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <form method="post" action="{{ route('admin.profile.update') }}" enctype="multipart/form-data" autocomplete="off">
                <div class="card-body">
                        @csrf
                        @method('put')
